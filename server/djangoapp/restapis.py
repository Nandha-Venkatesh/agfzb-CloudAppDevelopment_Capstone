...
def get_dealer_reviews_from_cf(url, **kwargs):
    ...
    if json_result:
        ...
        for dealer_review in reviews:
            ...
            # UNFORTUNATELY, THE CONNECTION TO THE IBM SENTIMENT ANALYZER NO LONGER WORKS. NOT SURE WHY!
...
def analyze_review_sentiments(text):
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/20d79df7-72e6-4874-b2fa-706598d4cd74"
    api_key = "L0zw6lwRpJ1VDqXp_JAOwPlu72LWbmUcj5MEzq6L77yn"
